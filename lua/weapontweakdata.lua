...
Hooks:PostHook(WeaponTweakData, "init", "eclipse_init", function(self, tweak_data)
	...
	--contractor pistol has the best anims specially in ads
	...
	self.ak74.fire_mode_data.fire_rate = 0.107 --akm fire rate
	...
	self.hk21.fire_mode_data.fire_rate = 0.092 --pdth fire rate
